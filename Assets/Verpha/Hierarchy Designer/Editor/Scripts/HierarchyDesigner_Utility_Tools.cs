...
namespace Verpha.HierarchyDesigner
{
    public static class HierarchyDesigner_Utility_Tools
    {
        ...
        #region Context menu
        #region Activate
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Tools + "/Activate Selected", false, HierarchyDesigner_Shared_MenuItems.LayerThirteen)]
        public static void ContextMenu_Activate_SelectedGameObjects() => Activate_SelectedGameObjects(true);
        #endregion

        #region Deactivate
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Tools + "/Deactivate Selected", false, HierarchyDesigner_Shared_MenuItems.LayerThirteen)]
        public static void ContextMenu_Deactivate_SelectedGameObjects() => Activate_SelectedGameObjects(false);
        #endregion

        #region Count
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Tools + "/Count Selected", false, HierarchyDesigner_Shared_MenuItems.LayerFourteen)]
        public static void ContextMenu_Count_SelectedGameObjects() => Count_SelectedGameObjects();
        #endregion

        #region Lock
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Tools + "/Lock Selected", false, HierarchyDesigner_Shared_MenuItems.LayerFifteen)]
        public static void ContextMenu_Lock_SelectedGameObjects() => Lock_SelectedGameObjects(true);
        #endregion

        #region Unlock
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Tools + "/Unlock Selected", false, HierarchyDesigner_Shared_MenuItems.LayerFifteen)]
        public static void ContextMenu_Unlock_SelectedGameObjects() => Lock_SelectedGameObjects(false);
        #endregion

        #region Rename
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Tools + "/Rename Selected", false, HierarchyDesigner_Shared_MenuItems.LayerSixteen)]
        public static void ContextMenu_Rename_SelectedGameObjects() => Rename_SelectedGameObjects("rename with automatic indexing", true);
        #endregion

        #region Select
        #region General
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select + "/Select All GameObjects", false, HierarchyDesigner_Shared_MenuItems.LayerFive)]
        public static void ContextMenu_Select_GameObjects() => Select_AllGameObjects();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select + "/Select All Parent GameObjects", false, HierarchyDesigner_Shared_MenuItems.LayerFive + 1)]
        public static void ContextMenu_Select_ParentGameObjects() => Select_AllParentGameObjects();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select + "/Select All Empty GameObjects", false, HierarchyDesigner_Shared_MenuItems.LayerSix + 1)]
        public static void ContextMenu_Select_EmptyGameObjects() => Select_AllEmptyGameObjects();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select + "/Select All Locked GameObjects", false, HierarchyDesigner_Shared_MenuItems.LayerSix + 1)]
        public static void ContextMenu_Select_LockedGameObjects() => Select_AllLockedGameObjects();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select + "/Select All Active GameObjects", false, HierarchyDesigner_Shared_MenuItems.LayerSeven + 1)]
        public static void ContextMenu_Select_ActiveGameObjects() => Select_AllActiveGameObjects();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select + "/Select All Inactive GameObjects", false, HierarchyDesigner_Shared_MenuItems.LayerSeven + 1)]
        public static void ContextMenu_Select_InactiveGameObjects() => Select_AllInactiveGameObjects();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select + "/Select All Folders", false, HierarchyDesigner_Shared_MenuItems.LayerEight + 1)]
        public static void ContextMenu_Select_Folders() => Select_AllFolders();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select + "/Select All Separators", false, HierarchyDesigner_Shared_MenuItems.LayerEight + 1)]
        public static void ContextMenu_Select_Separators() => Select_AllSeparators();
        #endregion

        #region Types (Select)
        #region 2D Objects
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_2D + "/Select All Sprites", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 1)]
        public static void ContextMenu_Select_Sprites() => Select_AllComponentOfType<SpriteRenderer>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_2D + "/Select All Sprite Masks", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 2)]
        public static void ContextMenu_Select_SpriteMasks() => Select_AllComponentOfType<SpriteMask>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_2D_Sprites + "/Select All 9-Sliced Sprites", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 2)]
        public static void ContextMenu_Select_9SlicedSprites() => Select_All2DSpritesByType("9-Sliced");

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_2D_Sprites + "/Select All Capsule Sprites", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 2)]
        public static void ContextMenu_Select_CapsuleSprites() => Select_All2DSpritesByType("Capsule");

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_2D_Sprites + "/Select All Circle Sprites", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 2)]
        public static void ContextMenu_Select_CircleSprites() => Select_All2DSpritesByType("Circle");

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_2D_Sprites + "/Select All Hexagon Flat-Top Sprites", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 2)]
        public static void ContextMenu_Select_HexagonFlatTopSprites() => Select_All2DSpritesByType("Hexagon Flat-Top");

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_2D_Sprites + "/Select All Hexagon Pointed-Top Sprites", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 2)]
        public static void ContextMenu_Select_HexagonPointedTopSprites() => Select_All2DSpritesByType("Hexagon Pointed-Top");

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_2D_Sprites + "/Select All Isometric Diamond Sprites", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 2)]
        public static void ContextMenu_Select_IsometricDiamondSprites() => Select_All2DSpritesByType("Isometric Diamond");

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_2D_Sprites + "/Select All Square Sprites", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 2)]
        public static void ContextMenu_Select_SquareSprites() => Select_All2DSpritesByType("Square");

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_2D_Sprites + "/Select All Triangle Sprites", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 2)]
        public static void ContextMenu_Select_TriangleSprites() => Select_All2DSpritesByType("Triangle");

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_2D_Physics + "/Select All Dynamic Sprites", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 3)]
        public static void ContextMenu_Select_PhysicsDynamicSprites() => Select_AllPhysicsDynamicSprites();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_2D_Physics + "/Select All Static Sprites", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 3)]
        public static void ContextMenu_Select_PhysicsStaticSprites() => Select_AllPhysicsStaticSprites();
        #endregion

        #region 3D Objects
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_3D + "/Select All Mesh Filters", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 1)]
        public static void ContextMenu_Select_MeshFilters() => Select_AllComponentOfType<MeshFilter>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_3D + "/Select All Mesh Renderers", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 1)]
        public static void ContextMenu_Select_MeshRenderers() => Select_AllComponentOfType<MeshRenderer>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_3D + "/Select All Skinned Mesh Renderer", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 1)]
        public static void ContextMenu_Select_SkinnedMeshRenderers() => Select_AllComponentOfType<SkinnedMeshRenderer>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_3D + "/Select All Cubes", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 1)]
        public static void ContextMenu_Select_CubesObjects() => Select_All3DObjectsByType("Cube");

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_3D + "/Select All Spheres", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 1)]
        public static void ContextMenu_Select_SpheresObjects() => Select_All3DObjectsByType("Sphere");

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_3D + "/Select All Capsules", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 2)]
        public static void ContextMenu_Select_CapsulesObjects() => Select_All3DObjectsByType("Capsule");

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_3D + "/Select All Cylinders", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 2)]
        public static void ContextMenu_Select_CylindersObjects() => Select_All3DObjectsByType("Cylinder");

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_3D + "/Select All Planes", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 2)]
        public static void ContextMenu_Select_PlanesObjects() => Select_All3DObjectsByType("Plane");

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_3D + "/Select All Quads", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 3)]
        public static void ContextMenu_Select_QuadsObjects() => Select_All3DObjectsByType("Quad");

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_3D + "/Select All Texts - TextMeshPro", false, HierarchyDesigner_Shared_MenuItems.LayerEleven + 3)]
        public static void ContextMenu_Select_TextMeshProObjects() => Select_All3DObjectsByType("TextMeshPro Mesh");

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_3D_Legacy + "/Select All Text Meshes", false, HierarchyDesigner_Shared_MenuItems.LayerEleven + 4)]
        public static void ContextMenu_Select_TextMeshesObjects() => Select_AllComponentOfType<TextMesh>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_3D + "/Select All Terrains", false, HierarchyDesigner_Shared_MenuItems.LayerTwelve + 4)]
        public static void ContextMenu_Select_TerrainsObjects() => Select_AllComponentOfType<Terrain>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_3D + "/Select All Trees", false, HierarchyDesigner_Shared_MenuItems.LayerTwelve + 4)]
        public static void ContextMenu_Select_TreesObjects() => Select_AllComponentOfType<Tree>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_3D + "/Select All Wind Zones", false, HierarchyDesigner_Shared_MenuItems.LayerTwelve + 4)]
        public static void ContextMenu_Select_WindZonesObjects() => Select_AllComponentOfType<WindZone>();
        #endregion

        #region Audio
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Audio + "/Select All Audio Sources", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 2)]
        public static void ContextMenu_Select_AudioSources() => Select_AllComponentOfType<AudioSource>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Audio + "/Select All Audio Reverb Zones", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 3)]
        public static void ContextMenu_Select_AudioReverbZones() => Select_AllComponentOfType<AudioReverbZone>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Audio + "/Select All Audio Chorus Filters", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 3)]
        public static void ContextMenu_Select_AudioChorusFilters() => Select_AllComponentOfType<AudioChorusFilter>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Audio + "/Select All Audio Distortion Filters", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 3)]
        public static void ContextMenu_Select_AudioDistortionFilters() => Select_AllComponentOfType<AudioDistortionFilter>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Audio + "/Select All Audio Echo Filters", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 3)]
        public static void ContextMenu_Select_AudioEchoFilters() => Select_AllComponentOfType<AudioEchoFilter>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Audio + "/Select All Audio High Pass Filters", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 3)]
        public static void ContextMenu_Select_AudioHighPassFilters() => Select_AllComponentOfType<AudioHighPassFilter>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Audio + "/Select All Audio Listeners", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 3)]
        public static void ContextMenu_Select_AudioListeners() => Select_AllComponentOfType<AudioListener>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Audio + "/Select All Audio Low Pass Filters", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 3)]
        public static void ContextMenu_Select_AudioLowPassFilters() => Select_AllComponentOfType<AudioLowPassFilter>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Audio + "/Select All Audio Reverb Filters", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 3)]
        public static void ContextMenu_Select_AudioReverbFilters() => Select_AllComponentOfType<AudioReverbFilter>();
        #endregion

        #region Effects
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Effects + "/Select All Particle Systems", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 2)]
        public static void ContextMenu_Select_ParticleSystems() => Select_AllComponentOfType<ParticleSystem>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Effects + "/Select All Particle System Force Fields", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 3)]
        public static void ContextMenu_Select_ParticleSystemForceFields() => Select_AllComponentOfType<ParticleSystemForceField>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Effects + "/Select All Trail Renderers", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 3)]
        public static void ContextMenu_Select_TrailRenderers() => Select_AllComponentOfType<TrailRenderer>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Effects + "/Select All Line Renderers", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 4)]
        public static void ContextMenu_Select_LineRenderers() => Select_AllComponentOfType<LineRenderer>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Effects + "/Select All Halos", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 4)]
        public static void ContextMenu_Select_Halos() => Select_AllHalos();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Effects + "/Select All Lens Flares", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 4)]
        public static void ContextMenu_Select_LensFlares() => Select_AllComponentOfType<LensFlare>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Effects + "/Select All Projectors", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 4)]
        public static void ContextMenu_Select_AllProjectors() => Select_AllComponentOfType<Projector>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Effects + "/Select All Visual Effects", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 4)]
        public static void ContextMenu_Select_VisualEffects() => Select_AllComponentOfType<UnityEngine.VFX.VisualEffect>();
        #endregion

        #region Lights
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Light + "/Select All Lights", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 2)]
        public static void ContextMenu_Select_Lights() => Select_AllComponentOfType<Light>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Light + "/Select All Directional Lights", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 2)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Light + "/Select All Point Lights", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 2)]
        public static void ContextMenu_Select_PointLights() => Select_AllComponentOfType<Light>(light => light.type == LightType.Point);

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Light + "/Select All Spot Lights", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 2)]
        public static void ContextMenu_Select_SpotLights() => Select_AllComponentOfType<Light>(light => light.type == LightType.Spot);

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Light + "/Select All Rectangle Area Lights", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 3)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Light + "/Select All Disc Area Lights", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 4)]
        public static void ContextMenu_Select_DiscAreaLights() => Select_AllComponentOfType<Light>(light => light.type == LightType.Disc);

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Light + "/Select All Reflection Probes", false, HierarchyDesigner_Shared_MenuItems.LayerEleven + 4)]
        public static void ContextMenu_Select_ReflectionProbes() => Select_AllComponentOfType<ReflectionProbe>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Light + "/Select All Light Probe Groups", false, HierarchyDesigner_Shared_MenuItems.LayerEleven + 5)]
        public static void ContextMenu_Select_LightProbeGroups() => Select_AllComponentOfType<LightProbeGroup>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Light + "/Select All Light Probe Proxy Volumes", false, HierarchyDesigner_Shared_MenuItems.LayerEleven + 5)]
        public static void ContextMenu_Select_LightProbeProxyVolumes() => Select_AllComponentOfType<LightProbeProxyVolume>();
        #endregion

        #region Video
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_Video + "/Select All Video Players", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 2)]
        public static void ContextMenu_Select_VideoPlayers() => Select_AllComponentOfType<UnityEngine.Video.VideoPlayer>();
        #endregion

        #region UI Toolkit
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UIToolkit + "/Select All UI Documents", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 3)]
        public static void ContextMenu_Select_UIDocuments() => Select_AllComponentOfType<UnityEngine.UIElements.UIDocument>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UIToolkit + "/Select All Panel Event Handlers", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 3)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UIToolkit + "/Select All Panel Raycasters", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 3)]
        public static void ContextMenu_Select_PanelRaycasters() => Select_AllComponentOfType<UnityEngine.UIElements.PanelRaycaster>();
        #endregion

        #region Cameras
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select + "/Select All Cameras", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 4)]
        public static void ContextMenu_Select_Cameras() => Select_AllComponentOfType<Camera>();
        #endregion

        #region UI
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI + "/Select All Images", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 4)]
        public static void ContextMenu_Select_Images() => Select_AllComponentOfType<Image>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI + "/Select All Texts - TextMeshPro", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 4)]
        public static void ContextMenu_Select_TextMeshPro() => Select_AllTMPComponentIfAvailable<TMPro.TMP_Text>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI + "/Select All Raw Images", false, HierarchyDesigner_Shared_MenuItems.LayerNine + 5)]
        public static void ContextMenu_Select_RawImages() => Select_AllComponentOfType<RawImage>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI + "/Select All Toggles", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 5)]
        public static void ContextMenu_Select_Toggles() => Select_AllComponentOfType<Toggle>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI + "/Select All Sliders", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 6)]
        public static void ContextMenu_Select_Sliders() => Select_AllComponentOfType<Slider>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI + "/Select All Scrollbars", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 7)]
        public static void ContextMenu_Select_Scrollbars() => Select_AllComponentOfType<Scrollbar>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI + "/Select All Scroll Views", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 8)]
        public static void ContextMenu_Select_ScrollViews() => Select_AllComponentOfType<ScrollRect>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI + "/Select All Dropdowns - TextMeshPro", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 9)]
        public static void ContextMenu_Select_DropdownTextMeshPro() => Select_AllTMPComponentIfAvailable<TMPro.TMP_Dropdown>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI + "/Select All Input Fields - TextMeshPro", false, HierarchyDesigner_Shared_MenuItems.LayerTen + 9)]
        public static void ContextMenu_Select_InputFieldTextMeshPro() => Select_AllTMPComponentIfAvailable<TMPro.TMP_InputField>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI + "/Select All Canvases", false, HierarchyDesigner_Shared_MenuItems.LayerEleven + 9)]
        public static void ContextMenu_Select_Canvases() => Select_AllComponentOfType<Canvas>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI + "/Select All Event Systems", false, HierarchyDesigner_Shared_MenuItems.LayerEleven + 9)]
        public static void ContextMenu_Select_EventSystems() => Select_AllComponentOfType<UnityEngine.EventSystems.EventSystem>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI_Legacy + "/Select All Texts", false, HierarchyDesigner_Shared_MenuItems.LayerTwelve + 9)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI_Legacy + "/Select All Input Fields", false, HierarchyDesigner_Shared_MenuItems.LayerTwelve + 10)]
        public static void ContextMenu_Select_InputFields() => Select_AllComponentOfType<InputField>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI + "/Select All Masks", false, HierarchyDesigner_Shared_MenuItems.LayerThirteen + 10)]
        public static void ContextMenu_Select_Masks() => Select_AllComponentOfType<Mask>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI + "/Select All Rect Masks 2D", false, HierarchyDesigner_Shared_MenuItems.LayerThirteen + 10)]
        public static void ContextMenu_Select_RectMasks2D() => Select_AllComponentOfType<RectMask2D>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI + "/Select All Selectables", false, HierarchyDesigner_Shared_MenuItems.LayerThirteen + 10)]
        public static void ContextMenu_Select_Selectables() => Select_AllComponentOfType<Selectable>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI + "/Select All Toggle Groups", false, HierarchyDesigner_Shared_MenuItems.LayerThirteen + 10)]
        public static void ContextMenu_Select_ToggleGroups() => Select_AllComponentOfType<ToggleGroup>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI_Effects + "/Select All Outlines", false, HierarchyDesigner_Shared_MenuItems.LayerThirteen + 10)]
        public static void ContextMenu_Select_Outlines() => Select_AllComponentOfType<Outline>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI_Effects + "/Select All Positions As UV1", false, HierarchyDesigner_Shared_MenuItems.LayerThirteen + 10)]
        public static void ContextMenu_Select_PositionsAsUV1() => Select_AllComponentOfType<PositionAsUV1>();

        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Select_Type_UI_Effects + "/Select All Shadows", false, HierarchyDesigner_Shared_MenuItems.LayerThirteen + 10)]
        ...
        #region Sort
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Sort + "/Sort Alphabetically Ascending", false, HierarchyDesigner_Shared_MenuItems.LayerFive)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Sort + "/Sort Alphabetically Descending", false, HierarchyDesigner_Shared_MenuItems.LayerFive)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Sort + "/Sort Components Amount Ascending", false, HierarchyDesigner_Shared_MenuItems.LayerSix)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Sort + "/Sort Components Amount Descending", false, HierarchyDesigner_Shared_MenuItems.LayerSix)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Sort + "/Sort Length Ascending", false, HierarchyDesigner_Shared_MenuItems.LayerSeven)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Sort + "/Sort Length Descending", false, HierarchyDesigner_Shared_MenuItems.LayerSeven)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Sort + "/Sort Tag Alphabetically Ascending", false, HierarchyDesigner_Shared_MenuItems.LayerEight)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Sort + "/Sort Tag Alphabetically Descending", false, HierarchyDesigner_Shared_MenuItems.LayerEight)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Sort + "/Sort Tag List Order Ascending", false, HierarchyDesigner_Shared_MenuItems.LayerNine)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Sort + "/Sort Tag List Order Descending", false, HierarchyDesigner_Shared_MenuItems.LayerNine)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Sort + "/Sort Layer Alphabetically Ascending", false, HierarchyDesigner_Shared_MenuItems.LayerTen)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Sort + "/Sort Layer Alphabetically Descending", false, HierarchyDesigner_Shared_MenuItems.LayerTen)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Sort + "/Sort Layer List Order Ascending", false, HierarchyDesigner_Shared_MenuItems.LayerEleven)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Sort + "/Sort Layer List Order Descending", false, HierarchyDesigner_Shared_MenuItems.LayerEleven)]
        ...
        [MenuItem(HierarchyDesigner_Shared_MenuItems.ContextMenu_Sort + "/Sort Randomly", false, HierarchyDesigner_Shared_MenuItems.LayerTwelve)]
